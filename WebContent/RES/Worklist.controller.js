...
sap.ui.controller("sap.ui.zmbr.asrep20.RES.Worklist", {
	...
	if (!this._oDialog) {
	    this._oDialog = sap.ui.xmlfragment("sap.ui.zmbr.asrep20.RES.ReportHeaderDlg", this);
	...
	if (sQuery) {
		...
		filters : [ new sap.ui.model.Filter("Dealername", "Contains", sQuery),
			new sap.ui.model.Filter("Month", "Contains", sQuery), new sap.ui.model.Filter("Status", "Contains", sQuery) ],
		and : false
	    }));
	}
